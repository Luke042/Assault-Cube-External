...
void gui::Render() noexcept
{
	...
	if (ImGui::Begin("Assault Cube External")) {
		...
		if (ImGui::BeginTabBar("tabs"))
		{
			...
			{
				ImGui::Checkbox("Aimbot(Broken/Fix Later)", &aim::aimbot_toggle);
				ImGui::EndTabItem();
			}
			...
			if (ImGui::BeginTabItem("Exploits"))
			{
				...
				ImGui::Checkbox("Static Health(Broken/Fix Later)", &exploits::static_health);
				...
				if (exploits::fly == true) {
					ImGui::SliderFloat("fly height", &values::fly_height, 0.0f, 10.0f);
					ImGui::Text("Controls:\nSpace to fly\nShift to unstuck");
				}
